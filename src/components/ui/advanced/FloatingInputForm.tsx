...
const FloatInputForm = React.forwardRef<
	HTMLInputElement,
	FloatInputFormProps & React.ComponentPropsWithoutRef<'div'>
>(
	(
		{
			type,
...
FloatInputForm.displayName = 'FloatInputForm'

export { FloatInputForm }
